...
//        mMap!!.setOnCameraIdleListener(this)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_map_with_searchbar)
    ...
    private fun askPermissionLocation() {
        askPermission(
            ...
            getCurrentLocation()
//          mapView.getMapAsync(this@MapWithSearchBar)
        }.onDeclined { e ->
            if (e.hasDenied()) {
                ...
                if (e.hasForeverDenied()) {
                    ...
                    //you need to open settings maually if you really need it
                    e.goToSettings();
                }
            }
        }
    ...
    private fun getCurrentLocation() {
        fusedLocationProviderClient =
            LocationServices.getFusedLocationProviderClient(this@MapWithSearchbar)
